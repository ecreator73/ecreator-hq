...
import { IntegrationForm } from "@/components/ai/integration-form";

/** "+ Integration"-Button mit Modal zum Anlegen einer Integration. */
export function IntegrationQuickCreate({
  label = "Integration",
}: {
  label?: string;
}) {
