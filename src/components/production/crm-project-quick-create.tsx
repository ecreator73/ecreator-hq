...
import { CrmProjectForm } from "@/components/production/crm-project-form";
...
/** "+ CRM-Projekt"-Button mit Modal. Optionen werden beim Oeffnen geladen. */
export function CrmProjectQuickCreate({
  clientId,
  variant = "primary",
  label = "CRM-Projekt",
}: {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Neues CRM-Projekt" size="lg">
        {options ? (
          <CrmProjectForm
            mode="create"
            options={options}
