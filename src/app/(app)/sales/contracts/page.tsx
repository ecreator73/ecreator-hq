...
import { contractsService, salesDashboardService } from "@/server/services";
...
export const metadata: Metadata = { title: "Sales - Vertraege" };
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="Sales"
        title="Vertraege"
        description="Laufende Vertraege, Werte und auslaufende Mandate im Blick."
      />
      ...
      <Card>
        ...
        <CardContent>
          {expiring.length === 0 ? (
            <EmptyState
              title="Keine auslaufenden Vertraege"
      ...
      {contracts.length === 0 ? (
        <EmptyState
          title="Keine Vertraege vorhanden"
          description="Sobald aus Angeboten Vertraege entstehen, erscheinen sie hier."
        />
      ) : (
